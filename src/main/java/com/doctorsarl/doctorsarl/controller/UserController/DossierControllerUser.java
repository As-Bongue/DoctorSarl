...
@Controller
@RequestMapping("/user")
public class DossierControllerUser {
    ...
    public String showAllDossiers(Model model){
        ...
        return "utilisateur/dossier/show_all";
    }
    ...
    public String showAllOpenedDossiers(Model model){
        ...
        model.addAttribute("dossiers", dossiers);
        return "utilisateur/dossier/opened";
    }
    ...
    public String showAllClosededDossiers(Model model){
        ...
        model.addAttribute("dossiers", dossiers);
        return "utilisateur/dossier/closed";
    }
...
//        List<Patient> patients = patientService.getAllPatient();
        ...
        return "utilisateur/dossier/create_form";
    }
    ...
    public String ceateDossier(Dossier dossier, RedirectAttributes r){
        ...
        return "redirect:/user/dossier_show/" +id;
    }
